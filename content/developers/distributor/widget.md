...
| <a name="cityId"></a>cityId | `string` | `null` | Id of the preselected city in *Multihotel* mode. Invalid or unset value will fallback to first valid city of any of your hotels. For finding an id of city, please contact our support at support@mews.li. 
